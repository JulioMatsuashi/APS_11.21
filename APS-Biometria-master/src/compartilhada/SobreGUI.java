...
public class SobreGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Mateus F. Diniz - N4210G-9");
        add(jLabel6);
        jLabel6.setBounds(10, 202, 213, 15);

        jLabel7.setFont(new java.awt.Font("Dialog", 0, 12));
        jLabel7.setText("Beatriz S. de Souza - N4758H-8");
        add(jLabel7);
        jLabel7.setBounds(10, 222, 213, 15);

        jLabel8.setFont(new java.awt.Font("Dialog", 0, 12));
        jLabel8.setText("Vitor S. Pellegrino - F001HF-0");
        add(jLabel8);
        jLabel8.setBounds(10, 242, 213, 15);

        jLabel9.setFont(new java.awt.Font("Dialog", 0, 12));
        jLabel9.setText("Julio H. M. Matsuashi - N409EH-0");
        add(jLabel9);
